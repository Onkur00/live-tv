                  ...
                  >
                    ...
                    {(['auto', 'high', 'medium', 'low'] as PlaybackQuality[]).map((q) => (
                      <button
                        ...
                        className={`px-3 py-1.5 text-left text-[11px] hover:bg-yellow-400 hover:text-slate-950 transition-colors cursor-pointer outline-hidden flex justify-between items-center ${
                          playbackQuality === q ? 'bg-yellow-400/10 text-yellow-400 font-bold' : 'text-slate-300'
                        }`}
                      >
